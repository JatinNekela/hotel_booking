...
const RoomDetails = () => {
    ...
    //onsubmit handler to check availability and book room
        ...
        <div className='py-28 md:py:35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='flex flex-col lg:flex-row gap-6 mt-6'>
                <div className='1g:w-1/2 w-full'>
                    <img src={mainImage} alt="Room Image" className='w-full rounded-x1 shadow-1g object-cover' />
                </div>
                ...
                <div>
                    ...
                    <div className='flex flex-wrap items-center gap-4 mt-3 mb-6'>
                        {room.amenities.map((item, index) => (
                            <div key={index} className='flex items-center py-2 px-3 gap-2 bg-gray-100 rounded-lg' >
            ...
            <form onSubmit={onSubmitHandler} ClassName='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0, 0.15) ] p-6 rounded-x1 mx-auto mt-16 max-w-6x1'>
                ...
                <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <input onChange={(e) => setGuests(e.target.value)} value={guests} type="number" id='guests' placeholder='Check-Out'
                            className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none' required />
                    </div>
