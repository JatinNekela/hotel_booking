        ...
        const mailOptions = {
            ...
            html: `
                ...
                <ul>
                    ...
                    <li> Date : </strong> ${booking._id}</li>
                    <li> Booking ID : </strong> ${process.env.CURRENCY || '$'} ${booking.totalPrice} /night</li>
                </ul>
                <p>We look forward to welcome you!</p>
                <p>If you need to make some changes, feel free to contact us.</p>
            `
        }
